...
export function getSupplierAccount(name: string): Promise<AccountStatement> { return request<AccountStatement>(`/accounts/supplier?name=${encodeURIComponent(name)}`) }
