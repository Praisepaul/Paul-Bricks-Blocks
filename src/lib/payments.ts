...
export function createPayment(input: { kind: 'customer_receipt' | 'supplier_payment'; customerId?: string; supplierName?: string; amount: number; paymentDate: string; method: string; reference: string; notes: string }): Promise<Payment> { return request<Payment>('/payments', { method: 'POST', body: JSON.stringify(input) }) }
